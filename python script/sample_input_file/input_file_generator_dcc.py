...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # #
    """.format(timestep = 5000001, size = axes_str, hard = stiffness, coo=coord_str)
    )
    input_all.close()
    return 0
    ...
    for a in axes:
        ...
        for b in stiffness:
            for coord in coord_list:
                print("{}{}{}{}".format(a, b, grid_spacing, coord))
